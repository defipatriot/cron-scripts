...
Data store: `defipatriot/bribes-data_2026`
---
What it captures
...
To capture these:
Walk Terra block history filtered by `wasm.contract_address = bribe-manager`
Decode each `MsgExecuteContract` matching the `add_bribe` pattern
Group by sender address, populate the bribers registry
